...
15 of the 1615 movies are missing from the Graph.
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013))+
  ...
  labs(
    x = "2013 Budget", 
    y = "2013 Gross Profit", 
    title = "Budget vs Gross Profit for movies on 2013"
  )
```
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, colour = binary)) +
  geom_point() + 
  labs(
    x = "Budget (in 2013 $)", 
...
#| warning: false
# add code here
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, colour = binary, size = roi)) +
  geom_point() + 
  labs(
    x = "Budget (in 2013 $)", 
    y = "Gross revenue (in 2013 $)", 
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, colour = binary, size = roi,
  ...
  facet_wrap(~ clean_test) +
  labs(
    x = "Budget (in million 2013 $)", 
    y = "Gross revenue (in million 2013 $)", 
    title = "Gross revenue vs. budget, by Bechdel test result",
    size = "Return on Investment"
  ) +
  scale_x_continuous(label = label_number(scale = 1/1000000)) +
...
This was a useful update because it shows which combination of clean_test and binary have PASS or FAIL results, but many panels are limited in the data they display.
...
# add code here
# code improvements: added a subtitle and also added a line of best fit.
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, 
                    colour = binary, 
                    size = roi,
                    alpha = 0.5)) +
  ...
  labs(
    ...
    subtitle = "Data from the Bechdel test result",
    size = "Return on Investment"
  ) +
  scale_x_continuous(label = label_number(scale = 1/1000000)) +
  scale_y_continuous(label = label_number(scale = 1/1000000))
...
ggplot(bechdel, aes(x = clean_test, y = roi, color = binary)) +
  ...
  labs(
    ...
    title = "Return on investment by Bechdel test outcome",
  )
```
